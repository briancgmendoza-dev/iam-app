...
const Sidebar: React.FC = () => {
  ...
  return (
    <div className="bg-slate-900/95 backdrop-blur-lg border-r border-white/10 text-white w-64 h-screen fixed left-0 top-0 overflow-y-auto">
      {/* Logo */}
      <div className="p-6 border-b border-white/10">
        <div className="flex items-center space-x-3">
          ...
          <h2 className="text-xl font-bold">IAM System</h2>
        </div>
      </div>
